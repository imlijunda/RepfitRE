...
function write_structures(wd::String, geo::Geometry, vasp = "POSCAR", dftb = "geo.gen")
...
function write_repscan_structures(wd::String, rsc::RepScale, vasp = "POSCAR", dftb = "geo.gen")
...
function read_repscan_energies!(wd::String, rsc::RepScale, vasp = "OUTCAR", dftb = "detailed.out")
